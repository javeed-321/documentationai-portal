...
description: How OM Plus security works, and the order to set it up.
---
...
<Steps>
  <Step title="Set up permission models" icon="shield">
    Configure the [permission models](/om-plus-dm/security/permission-models) that define the functions users can perform.
  </Step>
  <Step title="Create new security groups" icon="users">
    Create the [security groups](/om-plus-dm/security/security-groups) that group users with common destination and access needs.
  </Step>
  <Step title="Select destinations for the groups" icon="printer">
    Assign the destinations that each [security group](/om-plus-dm/security/security-groups) can access.
  </Step>
  <Step title="Assign proper permission models to each destination" icon="check">
    Apply the appropriate [permission model](/om-plus-dm/security/permission-models) to each destination.
  </Step>
  ...
  <Step title="Assign users to groups" icon="user-plus">
    Add [users and logins](/om-plus-dm/security/users-logins) to the appropriate groups.
  </Step>
</Steps>
