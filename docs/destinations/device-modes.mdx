...
Type is used to link a Windows Print driver with an OM Plus Destination. In a properly configured system, OM Plus will automatically create shared Windows print queues for devices defined with a type. For setting up types, see the [Types configuration screen](/om-plus-dm/destinations/types).
